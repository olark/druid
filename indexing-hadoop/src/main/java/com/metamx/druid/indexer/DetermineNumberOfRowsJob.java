 ...
 */
public class DetermineNumberOfRowsJob implements Jobby
{
  private static final Logger log = new Logger(DetermineNumberOfRowsJob.class);
  ...
  public DetermineNumberOfRowsJob(
...
//      groupByJob.setCombinerClass(DeterminePartitionsGroupByCombiner.class);
  ...
  public static class DeterminePartitionsGroupByMapper extends HadoopDruidIndexerMapper<BytesWritable, BytesWritable>
  {
      ...
      extends Reducer<BytesWritable, BytesWritable, BytesWritable, BytesWritable>
  {
    ...
    ) throws IOException, InterruptedException
    {
      for (BytesWritable value : values) {
        hyperLogLog.offerHashed(Longs.fromByteArray(value.getBytes()));
      }

      long x = hyperLogLog.cardinality();
      context.write(key, new BytesWritable(hyperLogLog.getBytes()));
    }
  }
      ...
      extends Reducer<BytesWritable, BytesWritable, BytesWritable, LongWritable>
  {
    ...
    ) throws IOException, InterruptedException
    {
      ...
      for (BytesWritable value : values) {
        try {
          final HyperLogLog other = HyperLogLog.Builder.build(value.getBytes());
          hyperLogLog.addAll(other);
        }
