...
/**
 */
public class IndexGeneratorJob2 implements Jobby
{
  private static final Logger log = new Logger(IndexGeneratorJob2.class);

  private final HadoopDruidIndexerConfig config;
  private IndexGeneratorStats jobStats;

  public IndexGeneratorJob2(
  ...
  public boolean run()
  {
    try {
      ...
      job.setJarByClass(IndexGeneratorJob2.class);
